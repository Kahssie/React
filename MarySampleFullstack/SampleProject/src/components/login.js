...
<Header/>
    ...
    <div className='clslogin'>
        ...
        <input type="text" id="mailid" value={mailid} onChange={(evt)=>setMailid(evt.target.value)}/>
        ...
        <Button className="butlogin" variant="contained" color="secondary" onClick={handleEvent}>
            Login
</Button>
        </div> 
    </div>
